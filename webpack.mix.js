...
/*
 ...
 | -----------------------------------------------
 | Using your view with mix('css/kodif.css', 'vendor/kodif')
...
mix
    .postCss('resources/css/kodif.css', 'css', [require('tailwindcss')('tailwind.config.js')])
    .js('resources/js/kodif.js', 'js')
    .version()
